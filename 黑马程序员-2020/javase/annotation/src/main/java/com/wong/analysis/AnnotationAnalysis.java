package com.wong.analysis;

import com.wong.our.Book;
import com.wong.our.BookShelf;
 ...
 * 获取注解上的属性值
 *
 * @Book(bookName = "红楼梦", price = 200.99, author = {"曹雪芹", "高鹗"})
 * <p>
 ...
 * 返回注解
 * 解释：
 * 参数传递的是任意注解的class文件对象
 * 传递什么类型，返回什么类型
 * 实现类：Class类，Constructor构造方法，Field成员遍历，Method成员方法
...
public class AnnotationAnalysis {
    ...
    public void test() throws ClassNotFoundException, NoSuchMethodException {
        //反射BookShelf
        Class c = Class.forName("com.wong.our.BookShelf");
        //反射获取方法sellBook

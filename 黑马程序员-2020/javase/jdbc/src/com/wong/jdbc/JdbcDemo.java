...
public class JdbcDemo {
    public static void main(String[] args) throws SQLException {
        ...
        //静态方法 static void registerDriver(Driver driver)
        ...
        //3：连接对象来获取SQL语句执行对象
        //连接对象Connection的方法 createStatement()获取SQL语句执行对象

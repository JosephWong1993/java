 ...
 * <p>
 * JDK1.5 出现了新报juc java.util.concurrent 并发包
 * lcoks包 Lock接口，方法 lock() 释放锁unlock() 取代同步synchronized，去掉了Object类中的线程通信方法
 * <p>
 ...
 * Lock是接口，如何调用接口中的方法newCondition()；Lock接口的实现类
 * <p>
 * Condition接口实现原理
 ...
 * 方法 signal() 唤醒线程：线程从阻塞队列中拿出，线程重新获取锁
 * <p>
 * Object：notifyAll() 满足多生产和多消费，不得已唤醒了全部的线程（浪费资源）

...
![](08-项目-创够商场-02-分布式文件存储-assets/2-5.png)

Preflight Request：

![](08-项目-创够商场-02-分布式文件存储-assets/2-6.png)

然后服务器端给我们返回一个PreflightResponse

![](08-项目-创够商场-02-分布式文件存储-assets/2-7.png)
...
![1559117928459](08-项目-创够商场-02-分布式文件存储-assets/1559117928459.png)

#### 5.1.2 上传流程

![1559117994668](08-项目-创够商场-02-分布式文件存储-assets/1559117994668.png)

客户端上传文件后存储服务器将文件 ID 返回给客户端，此文件 ID 用于以后访问该文件的索引信息。文件索引信息包括：组名，虚拟磁盘路径，数据两级目录，文件名。

![1559118013272](08-项目-创够商场-02-分布式文件存储-assets/1559118013272.png)

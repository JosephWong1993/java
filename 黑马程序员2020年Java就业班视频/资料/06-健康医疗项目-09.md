...
![2](06-健康医疗项目-09-img/2.png)

下载完成可以得到如下文件：

![6](06-健康医疗项目-09-img/6.png)



解压上面的zip文件：

![7](06-健康医疗项目-09-img/7.png)



我们只需要将dist目录下的echarts.js文件引入到页面上就可以使用了

![8](06-健康医疗项目-09-img/8.png)

...
![2](06-健康医疗项目-02-assets/2.png)



![3](06-健康医疗项目-02-assets/3.png)

（2）创建本项目使用的数据库health

![4](06-健康医疗项目-02-assets/4.png)

（3）将PowerDesigner导出的SQL脚本导入health数据库进行建表

![5](06-健康医疗项目-02-assets/5.png)

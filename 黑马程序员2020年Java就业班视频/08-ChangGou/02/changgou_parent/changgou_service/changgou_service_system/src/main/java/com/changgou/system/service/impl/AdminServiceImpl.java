...
public class AdminServiceImpl implements AdminService {
    ...
    public void add(Admin admin){
        ...
        String pwdEncrypt = BCrypt.hashpw(pwdText, BCrypt.gensalt());//基于管理员添加的用户明文密码生成密文密码
        admin.setPassword(pwdEncrypt);
        admin.setStatus("1");//启用用户
    ...
    public boolean login(Admin admin) {
        ...
        Admin dbAdmin = adminMapper.selectOne(cond);
        if(dbAdmin==null){
            return false;
        }

...
![1562633553559](05-dubbo-assets/1562633553559.png)

### 单一应用架构

当网站流量很小时，只需一个应用，将所有功能都部署在一起，以减少部署节点和成本。此时，用于简化增删改查工作量的数据访问框架(ORM)是关键。

![1562658873573](05-dubbo-assets/1562658873573.png)

### 垂直应用架构

当访问量逐渐增大，单一应用增加机器带来的加速度越来越小，将应用拆成互不相干的几个应用，以提升效率。此时，用于加速前端页面开发的Web框架(MVC)是关键。

![1562658931553](05-dubbo-assets/1562658931553.png)

### 分布式服务架构

当垂直应用越来越多，应用之间交互不可避免，将核心业务抽取出来，作为独立的服务，逐渐形成稳定的服务中心，使前端应用能更快速的响应多变的市场需求。此时，用于提高业务复用及整合的分布式服务框架(RPC)是关键。

![1562658953366](05-dubbo-assets/1562658953366.png)

### 流动计算架构

当服务越来越多，容量的评估，小服务资源的浪费等问题逐渐显现，此时需增加一个调度中心基于访问压力实时管理集群容量，提高集群利用率。此时，用于提高机器利用率的资源调度和治理中心(SOA)是关键。

![1562659024662](05-dubbo-assets/1562659024662.png)
...
![1562656624997](05-dubbo-assets/1562656624997.png)

### RPC调用

![1562656641829](05-dubbo-assets/1562656641829.png)
...
![1562888790694](05-dubbo-assets/1562888790694.png)
...
![1562659835206](05-dubbo-assets/1562659835206-1574317897207.png)
...
+ project name:studydubbo
  ...
  ![1562719183259](05-dubbo-assets/1562719183259.png)

  2. 父工程不实现任何代码，删除 src 目录，如图所示：

  ![1562719198087](05-dubbo-assets/1562719198087.png)
  ...
  ![1562726437476](05-dubbo-assets/1562726437476.png)
...
![1562726588504](05-dubbo-assets/1562726588504.png)

![1562728591027](05-dubbo-assets/1562728591027.png)
...
2. 修改pom.xml，增加打包方式
   ...
   ![1562728703972](05-dubbo-assets/1562728703972.png)
...
![1562728850588](05-dubbo-assets/1562728850588.png)
...
![1562729178324](05-dubbo-assets/1562729178324.png)
...
![1562730187564](05-dubbo-assets/1562730187564.png)
...
![1562732492202](05-dubbo-assets/1562732492202.png)
...
![1562730928702](05-dubbo-assets/1562730928702.png)
...
![1562731491516](05-dubbo-assets/1562731491516.png)
...
![1562731771609](05-dubbo-assets/1562731771609.png)

2、启动当前应用，启动后默认注册服务到zookeeper注册中心

![1562731913108](05-dubbo-assets/1562731913108.png)

![1562732519578](05-dubbo-assets/1562732519578.png)

3、检查是否注册到zookeeper

登录zookeeper客户端，直接查看ls /dubbo/com.itheima.study.dubbo.service.UserService节点

![1562733560343](05-dubbo-assets/1562733560343.png)
...
![1562733741426](05-dubbo-assets/1562733741426.png)
...
![1562736489923](05-dubbo-assets/1562736489923.png)
...
![1562739430619](05-dubbo-assets/1562739430619.png)
...
![1562739741394](05-dubbo-assets/1562739741394.png)
...
![1562740114711](05-dubbo-assets/1562740114711.png)



![1562740186415](05-dubbo-assets/1562740186415.png)

![1562740202630](05-dubbo-assets/1562740202630.png)
...
![1562740643986](05-dubbo-assets/1562740643986.png)

+ 在UserServiceImpl类中头部，使用注解

  ![1562740763707](05-dubbo-assets/1562740763707.png)

  ![1562740784084](05-dubbo-assets/1562740784084.png)

####    2.服务消费者，使用注解实现

+ 把spring-dubbo-consumer中的控制器初始化及服务订阅配置注释掉，如图所示

![1562740911585](05-dubbo-assets/1562740911585.png)

+ 采用注解初始化控制器

  在控制器头部加入@Controller,如图所示：

  ![1562741128909](05-dubbo-assets/1562741128909.png)

+ 采用注解订阅远程服务对象

  把原来通过配置文件的实现注释掉，然后在private UserService userService前面，使用@Reference，来订阅远程服务对象。

  ![1562741175665](05-dubbo-assets/1562741175665.png)

​     如图所示：

![1562741396004](05-dubbo-assets/1562741396004.png)
...
+ 测试负载均衡效果
  ...
  1. 服务端不指定负载策略，启动第1个实例
     ...
     ![1562743547846](05-dubbo-assets/1562743547846.png)

     + 修改 spring-dubbo-provider.xml，把dubbo通信端口改为8881 

       【实际开发，如部署到多个机器，无需此操作】

       ![1562743642930](05-dubbo-assets/1562743642930.png)

     + 修改pom.xml，端口改为8001

       【实际开发，如部署到多个机器，无需此操作】

       ![1562743678473](05-dubbo-assets/1562743678473.png)

     + 启动tomcat

       ![1562743723766](05-dubbo-assets/1562743723766.png)

  2. 服务端不指定负载策略，启动第2个实例

     + 修改服务实现源码，加入打印信息，比如

       ![1562743837590](05-dubbo-assets/1562743837590.png)

     + 修改 spring-dubbo-provider.xml，把dubbo通信端口改为8882

       ![1562743885001](05-dubbo-assets/1562743885001.png)

     + 修改pom.xml，端口改为8002

       ![1562743908098](05-dubbo-assets/1562743908098.png)
     ...
     + 查看dubbo控制台
       ...
       ![1562743973093](05-dubbo-assets/1562743973093.png)

     启动了两个服务实例

  3. 客户端指定负载策略（轮询策略）

     ![1562744005861](05-dubbo-assets/1562744005861.png)
